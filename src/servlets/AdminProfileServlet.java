...
@WebServlet(name = "AdminProfileServlet", urlPatterns = { "/admin/profile", "/admin/profile/changePassword",
		"/admin/profile/changeImage", "/admin/profile/edit", "/lecturer/profile", "/lecturer/profile/changePassword",
		"/lecturer/profile/changeImage", "/lecturer/profile/edit" })
public class AdminProfileServlet extends BaseServlet {
	...
	public void handlePost(HttpServletRequest request, HttpServletResponse response) {
		...
		case "/admin/profile/edit":
			...
			break;
		case "/lecturer/profile/edit":
			editProfileLec(request, response);
			break;
		case "/admin/profile/changeImage":
			editImage(request, response);
			break;
		case "/lecturer/profile/changeImage":
			editImageLec(request, response);
			break;
		case "/admin/profile/changePassword":
			editPass(request, response);
			break;
		case "/lecturer/profile/changePassword":
			editPassLec(request, response);
			break;
		default:
	...
	private void showViewLec(HttpServletRequest request, HttpServletResponse response) {
		try {
			forward(request, response, "/jsp/lecturer/lecturer-profile.jsp");
		} catch (IOException | ServletException e) {
			// TODO: handle exception
			e.printStackTrace();
		}
...
//			request.setAttribute("message", "There was an error: " + ex.getMessage());
	...
	private void editProfileLec(HttpServletRequest request, HttpServletResponse response) {
		User user = (User) request.getSession().getAttribute("user");
		String firstName = request.getParameter("firstName");
		String lastName = request.getParameter("lastName");
		String maxim = request.getParameter("maxim");
		...
		try {
			if (UserDAO.getInstance().updateUser(user.getId(), user.getHashPassword(), firstName, lastName, address,
				...
				user.setAddress(address);
				user.setEmail(email);
				forward(request, response, "/lecturer/profile");
			} else {
				setErrorCode(request, ErrorCodes.UPDATE_PROFILE_ERROR);
				forward(request, response, "/lecturer/profile");
			}
	...
	private void editPassLec(HttpServletRequest request, HttpServletResponse response) {
		User user = (User) request.getSession().getAttribute("user");
	...
	private void editImageLec(HttpServletRequest request, HttpServletResponse response) {
		User user = (User) request.getSession().getAttribute("user");
