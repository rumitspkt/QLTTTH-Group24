							...
							<div class="notifi-dropdown js-dropdown">
								...
								<div class="notifi__item">
									...
									<div class="content">
										...
										<span class="daste">April 12, 2018 06:50</span>
									</div>
								</div>
								<div class="notifi__item">
						...
						<div class="account-item clearfix js-item-menu">
							...
							<div class="account-dropdown js-dropdown">
								<div class="info clearfix">
									<div class="image">
										<a href="#"> <img src="${pageContext.request.contextPath}/images/icon/avatar-01.jpg"
											alt="John Doe" />
										</a>
									</div>
									<div class="content">
								...
								<div class="account-dropdown__body">
									<div class="account-dropdown__item">
										<a href="${pageContext.request.contextPath}/lecturer/profile"> <i class="zmdi zmdi-account"></i>Profile
										</a>
									</div>
								</div>
