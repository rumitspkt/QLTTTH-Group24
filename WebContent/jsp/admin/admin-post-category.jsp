...
<body class="animsition">
									...
									<table class="table table-data2">
										...
										<tbody>
											<c:forEach items="${categories}" var="category">
												<tr class="tr-shadow model-row" modelId="${category.id}">
													<td class="model-id">${category.id}</td>
													<td class="model-title">${category.title}</td>
													<td class="model-description">${category.description}</td>
													<td>
														<div class="table-data-feature">
															<button modelId="${category.id}"
			...
			<div class="modal fade" id="addModal" tabindex="-1" role="dialog"
				...
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
						...
						<form action="${pageContext.request.contextPath}/admin/post/category/new"
							method="post" class="">
			...
			<div class="modal fade" id="deleteModal" tabindex="-1" role="dialog"
				...
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
						...
						<form id="deleteModal"
							action="${pageContext.request.contextPath}/admin/post/category/delete"
							method="post" class="">
			...
			<div class="modal fade" id="editModal" tabindex="-1" role="dialog"
				...
				<div class="modal-dialog modal-lg" role="document">
					<div class="modal-content">
						...
						<form id="editModal"
							action="${pageContext.request.contextPath}/admin/post/category/edit"
							method="post" class="">
							<div class="modal-body">
	...
	<!-- custom JS -->
	<script
		src="${pageContext.request.contextPath}/js/custom/admin-categories.js"></script>
</body>
</html>
<!-- end document -->
